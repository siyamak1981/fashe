    ...
    <div class="d-flex justify-content-center h-100 ">
        <div class="card mt-3">
            <div class="card-header mt-3 mb-2 ">
                <h4>ویرایش خبر جدید </h4>
            </div>

            <div class="card-body">
                <form method="post" role="form" enctype="multipart/form-data" action="index.php?c=news&a=edit">
                    <span><?php echo $edit_news_show['title']; ?></span>
                    <div class="input-group-lg input-group mb-3 mt-2">
                        <div class="input-group-prepend ">
                            <span class="input-group-text "><i class="fa fa-bars"></i></span>
                        </div>
                        <input type="text" class="form-control input-lg" name="frm[title]" value="<?php echo $edit_news_show['title']; ?>" placeholder="عنوان خبر را وارد کنید">
                    </div>
                    ...
                    <div class="input-group-lg input-group mb-3">
                        ...
                        <select class="form-control" name="frm[newcat_id]">
                            ...
                            <?php foreach ($newcat_list as $val) : ?>
                        ...
                        <textarea type="text" id="editor1" class="form-control input-lg " style="width:800" name="frm[body]" placeholder="توضیحات محصول">
                            </textarea>
                        <script>
