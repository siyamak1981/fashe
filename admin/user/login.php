...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="../public/default/../public/default/fonts/elegant-font/html-css/style.css">
<!--===============================================================================================-->
...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(../public/default/images/heading-pages-06.jpg);">
			...
			<div class="row">
				<div class="col-md-6 p-b-30">
					<div class="p-r-20 p-r-0-lg">
						<div class="contact-map size21" id="google_map" data-map-x="40.614439" data-map-y="-73.926781" data-pin="../public/default/images/icons/icon-position-map.png" data-scrollwhell="0" data-draggable="1"></div>
					</div>
				</div>
                ...
                <form action="#" method="post">
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="password" name="frm[password]" placeholder="passwoed">
						</div>

						<div class="w-size25">
							<!-- Button -->
							<input class="flex-c-m size2 bg1 bo-rad-23 hov1 m-text3 trans-0-4" type="submit" value="send" name= "btn" />
